...
public class OrderManager {
	private static final Logger logger = Logger
			.getLogger("order.web.OrderManager");
	...
	public void findVendor() {
		try {
			...
			logger.info("Found " + vendorSearchResults.size()
	...
	public void submitOrder() {
		try {
			...
			logger.info("Created new order with order ID " + newOrderId
	...
	public void addLineItem() {
		try {
			...
			logger.info("There are " + lineItems.size() + " line items in "
					+ currentOrder + ".");
			...
			logger.warning("Problem adding line items to order ID "
					+ newOrderId);
		}
	}
	...
	/**
	 * @param newOrderShippingInfo
	 *            the newOrderShippingInfo to set
	 */
	...
	/**
	 * @param newOrderDiscount
	 *            the newOrderDiscount to set
	 */
	...
	/**
	 * @param vendorSearchResults
	 *            the vendorSearchResults to set
	 */
	...
	/**
	 * @param newOrderSelectedParts
	 *            the newOrderSelectedParts to set
	 */
	...
	/**
	 * @param selectedPartNumber
	 *            the selectedPartNumber to set
	 */
	...
	/**
	 * @param selectedPartRevision
	 *            the selectedPartRevision to set
	 */
	...
	/**
	 * @param selectedVendorPartNumber
	 *            the selectedVendorPartNumber to set
	 */
	...
	/**
	 * @param findVendorTableDisabled
	 *            the findVendorTableDisabled to set
	 */
	...
	/**
	 * @param partsTableDisabled
	 *            the partsTableDisabled to set
	 */
